...
stopwords = {}
isCN = 1 #默认启用中文分词
back_coloring_path = "Data/love.jpg" # 设置背景图片路径
text_path = 'Data/lz.txt' #设置要分析的文本路径
font_path = 'Data/simkai.ttf' # 为matplotlib设置中文字体路径没
stopwords_path = 'Data/stopwords1893.txt' # 停用词词表
